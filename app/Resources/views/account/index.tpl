<div class="row-fluid user-card">
	...
	<div class="span6 user-center">
		...
		<div class="user-like">
			<input class="btn btn-warning" type="button" value="ЛАЙК!"> <img src="/bundles/public/img/heart.png"> : <span id="like-counter">21</span>
		</div>	
		<ul class="user-data">
		...
		<a class="user-link" href="/account/edit">редактировать анкету</a>
	</div>

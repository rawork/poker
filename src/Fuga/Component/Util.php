...
class Util {
	...
	public function format_date($str, $format) {
		...
		$locale = $this->session('locale', false, PRJ_LOCALE);
		if ($locale != 'en') {
			$smonth = array(
				'ru' => array('Jan' => 'янв', 'Feb' => 'фев', 'Mar' => 'мар', 'Apr' => 'апр', 'May' => 'мая', 'Jun' => 'июн', 'Jul' => 'июл', 'Aug' => 'авг', 'Sep' => 'сент', 'Oct' => 'окт', 'Nov'  => 'нояб', 'Dec' => 'дек'),
				'ua' => array(),
			);
			$month = array(
	...
	public function request($key, $is_num = false, $default = ''){
		if (isset($_GET[$key])) {
